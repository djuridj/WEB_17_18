...
/**
 * Servlet implementation class RefuseCommentComplaint
 */
@WebServlet("/RefuseCommentComplaint")
public class RefuseCommentComplaint extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RefuseCommentComplaint() {
        super();
