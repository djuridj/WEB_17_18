...
/**
 * Servlet implementation class DislikeTopic
 */
@WebServlet("/DislikeTopic")
public class DislikeTopic extends HttpServlet {
...
String path = servlets.Registration.path;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int dislikes = Integer.parseInt(request.getParameter("dislikes"))+1;
